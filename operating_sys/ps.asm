...
free(void *ap)
{
 ...
 571:	a1 6c 07 00 00       	mov    0x76c,%eax
{
 ...
 5b1:	5b                   	pop    %ebx
  freep = p;
 5b2:	89 15 6c 07 00 00    	mov    %edx,0x76c
}
 5b8:	5e                   	pop    %esi
 5b9:	5f                   	pop    %edi
 5ba:	5d                   	pop    %ebp
 ...
 5e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5ec:	89 15 6c 07 00 00    	mov    %edx,0x76c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 3d 6c 07 00 00    	mov    0x76c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 64f:	73 4f                	jae    6a0 <malloc+0xa0>
    ...
    if(p == freep)
 651:	8b 3d 6c 07 00 00    	mov    0x76c,%edi
 ...
 67a:	e8 f1 fe ff ff       	call   570 <free>
  return freep;
 67f:	8b 15 6c 07 00 00    	mov    0x76c,%edx
 ...
 6ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6af:	89 15 6c 07 00 00    	mov    %edx,0x76c
}
 ...
 6bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 6c 07 00 00 70 	movl   $0x770,0x76c
 6c7:	07 00 00 
    base.s.size = 0;
 6ca:	bf 70 07 00 00       	mov    $0x770,%edi
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 70 07 00 00 70 	movl   $0x770,0x770
 6d6:	07 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6db:	c7 05 74 07 00 00 00 	movl   $0x0,0x774
 6e2:	00 00 00 
    if(p->s.size >= nunits){
