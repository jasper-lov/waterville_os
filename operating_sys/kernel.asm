...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 83 79 10 80 	movl   $0x80107983,(%esp)
...
80100dd4:	e8 b7 5d 00 00       	call   80106b90 <switchuvm>
  freevm(oldpgdir);
80100dd9:	89 3c 24             	mov    %edi,(%esp)
80100ddc:	e8 8f 61 00 00       	call   80106f70 <freevm>
  return 0;
...
8010383f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103842:	c7 40 14 df 59 10 80 	movl   $0x801059df,0x14(%eax)
  p->context = (struct context*)sp;
...
80103965:	68 b0 79 10 80       	push   $0x801079b0
...
80103ca0:	e8 eb 2e 00 00       	call   80106b90 <switchuvm>
...
80103cb2:	e8 f4 0c 00 00       	call   801049ab <swtch>
      switchkvm();
80103cb7:	e8 c4 2e 00 00       	call   80106b80 <switchkvm>
      c->proc = 0;
...
80103fa9:	e8 c2 2f 00 00       	call   80106f70 <freevm>
        p->pid = 0;
...
8010421b:	68 83 79 10 80       	push   $0x80107983
...
80104248:	8b 14 85 f8 79 10 80 	mov    -0x7fef8608(,%eax,4),%edx
      state = "???";
...
801042d7:	c7 04 24 d8 79 10 80 	movl   $0x801079d8,(%esp)
801042de:	e8 bd c3 ff ff       	call   801006a0 <cprintf>

for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042e3:	83 c4 10             	add    $0x10,%esp
801042e6:	eb 1d                	jmp    80104305 <ps+0x45>
...
8010432a:	75 d9                	jne    80104305 <ps+0x45>
...
8010433f:	c3                   	ret    
    cprintf("%s \t %d \t RUNNING \t %d \n", p->name, p->pid, p->priority);
80104340:	ff 73 10             	push   0x10(%ebx)
80104343:	ff 73 a4             	push   -0x5c(%ebx)
80104346:	53                   	push   %ebx
80104347:	68 52 79 10 80       	push   $0x80107952
8010434c:	e8 4f c3 ff ff       	call   801006a0 <cprintf>
80104351:	83 c4 10             	add    $0x10,%esp
80104354:	eb a4                	jmp    801042fa <ps+0x3a>
...
80104394:	fb                   	sti    
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104395:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010439a:	83 c4 10             	add    $0x10,%esp
8010439d:	eb 0b                	jmp    801043aa <chpr+0x2a>
8010439f:	90                   	nop
...
801043da:	68 10 7a 10 80       	push   $0x80107a10
...
80104615:	68 1b 7a 10 80       	push   $0x80107a1b
8010461a:	e8 61 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010461f:	83 ec 0c             	sub    $0xc,%esp
80104622:	68 32 7a 10 80       	push   $0x80107a32
...
8010468b:	68 39 7a 10 80       	push   $0x80107a39
...
80104780:	68 41 7a 10 80       	push   $0x80107a41
...
80104ba7:	83 fa 16             	cmp    $0x16,%edx
...
80104bd8:	68 49 7a 10 80       	push   $0x80107a49
...
80104d34:	68 fc 7a 10 80       	push   $0x80107afc
...
80104d4c:	68 fb 7a 10 80       	push   $0x80107afb
...
80104d61:	68 ef 7a 10 80       	push   $0x80107aef
...
80104d7f:	68 fe 7a 10 80       	push   $0x80107afe
80104d84:	e8 f7 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d89:	83 ec 0c             	sub    $0xc,%esp
80104d8c:	68 e0 7a 10 80       	push   $0x80107ae0
...
8010518d:	58                   	pop    %eax
8010518e:	5a                   	pop    %edx
8010518f:	68 fc 7a 10 80       	push   $0x80107afc
...
801051a8:	68 fb 7a 10 80       	push   $0x80107afb
...
{
  return ps();
80105970:	e9 4b e9 ff ff       	jmp    801042c0 <ps>
...
8010598c:	e8 bf f0 ff ff       	call   80104a50 <argint>
...
801059a1:	e8 aa f0 ff ff       	call   80104a50 <argint>
...
801059b3:	ff 75 f0             	push   -0x10(%ebp)
801059b6:	e8 c5 e9 ff ff       	call   80104380 <chpr>
...
80105a07:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105a0e:	08 00 00 8e 
80105a12:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105a19:	80 
80105a1a:	c1 ea 10             	shr    $0x10,%edx
80105a1d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105a24:	80 
  for(i = 0; i < 256; i++)
...
80105a37:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105a3e:	00 00 ef 
  initlock(&tickslock, "time");
80105a41:	68 41 7b 10 80       	push   $0x80107b41
80105a46:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a4b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105a51:	c1 e8 10             	shr    $0x10,%eax
80105a54:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
80105a7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a7f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105ac4:	ff 24 85 e8 7b 10 80 	jmp    *-0x7fef8418(,%eax,4)
...
80105ada:	e8 b1 de ff ff       	call   80103990 <myproc>
80105adf:	85 c0                	test   %eax,%eax
80105ae1:	74 1d                	je     80105b00 <trap+0x60>
80105ae3:	e8 a8 de ff ff       	call   80103990 <myproc>
...
80105b09:	e8 82 de ff ff       	call   80103990 <myproc>
...
80105b12:	0f 84 b8 00 00 00    	je     80105bd0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b18:	e8 73 de ff ff       	call   80103990 <myproc>
...
80105b50:	e8 3b de ff ff       	call   80103990 <myproc>
...
80105b70:	e8 fb dd ff ff       	call   80103970 <cpuid>
...
80105b81:	e8 0a de ff ff       	call   80103990 <myproc>
80105b86:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b89:	e8 02 de ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ba5:	68 a4 7b 10 80       	push   $0x80107ba4
80105baa:	e8 f1 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105baf:	83 c4 20             	add    $0x20,%esp
80105bb2:	e8 d9 dd ff ff       	call   80103990 <myproc>
80105bb7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bbe:	e8 cd dd ff ff       	call   80103990 <myproc>
...
80105bd4:	0f 85 3e ff ff ff    	jne    80105b18 <trap+0x78>
    yield();
80105bda:	e8 31 e4 ff ff       	call   80104010 <yield>
...
80105bef:	e8 7c dd ff ff       	call   80103970 <cpuid>
80105bf4:	57                   	push   %edi
80105bf5:	56                   	push   %esi
80105bf6:	50                   	push   %eax
80105bf7:	68 4c 7b 10 80       	push   $0x80107b4c
...
80105c1f:	90                   	nop
    if(myproc()->killed)
80105c20:	e8 6b dd ff ff       	call   80103990 <myproc>
...
80105c35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c38:	e8 53 ef ff ff       	call   80104b90 <syscall>
    if(myproc()->killed)
80105c3d:	e8 4e dd ff ff       	call   80103990 <myproc>
...
80105c53:	5d                   	pop    %ebp
      exit();
80105c54:	e9 57 e1 ff ff       	jmp    80103db0 <exit>
80105c59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105c60:	e8 5b 02 00 00       	call   80105ec0 <uartintr>
    lapiceoi();
...
80105c9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105ca0:	e8 cb dc ff ff       	call   80103970 <cpuid>
80105ca5:	85 c0                	test   %eax,%eax
80105ca7:	0f 85 28 fe ff ff    	jne    80105ad5 <trap+0x35>
      acquire(&tickslock);
80105cad:	83 ec 0c             	sub    $0xc,%esp
80105cb0:	68 80 3d 11 80       	push   $0x80113d80
80105cb5:	e8 16 ea ff ff       	call   801046d0 <acquire>
      wakeup(&ticks);
80105cba:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105cc1:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105cc8:	e8 53 e4 ff ff       	call   80104120 <wakeup>
      release(&tickslock);
80105ccd:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105cd4:	e8 97 e9 ff ff       	call   80104670 <release>
...
80105ce1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105ce8:	e8 c3 e0 ff ff       	call   80103db0 <exit>
...
80105db7:	0f 84 93 00 00 00    	je     80105e50 <uartinit+0xf0>
  uart = 1;
80105dbd:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105dc4:	00 00 00 
80105dc7:	89 fa                	mov    %edi,%edx
80105dc9:	ec                   	in     (%dx),%al
80105dca:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105dcf:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105dd0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105dd3:	bf 68 7c 10 80       	mov    $0x80107c68,%edi
80105dd8:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105ddd:	6a 00                	push   $0x0
80105ddf:	6a 04                	push   $0x4
80105de1:	e8 aa c6 ff ff       	call   80102490 <ioapicenable>
80105de6:	c6 45 e7 76          	movb   $0x76,-0x19(%ebp)
80105dea:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105ded:	c6 45 e6 78          	movb   $0x78,-0x1a(%ebp)
80105df1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105df8:	a1 c0 45 11 80       	mov    0x801145c0,%eax
80105dfd:	bb 80 00 00 00       	mov    $0x80,%ebx
80105e02:	85 c0                	test   %eax,%eax
80105e04:	75 1c                	jne    80105e22 <uartinit+0xc2>
80105e06:	eb 2b                	jmp    80105e33 <uartinit+0xd3>
...
80105e20:	74 07                	je     80105e29 <uartinit+0xc9>
80105e22:	89 f2                	mov    %esi,%edx
80105e24:	ec                   	in     (%dx),%al
80105e25:	a8 20                	test   $0x20,%al
80105e27:	74 e7                	je     80105e10 <uartinit+0xb0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e29:	0f b6 45 e6          	movzbl -0x1a(%ebp),%eax
80105e2d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e32:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105e33:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105e37:	83 c7 01             	add    $0x1,%edi
80105e3a:	84 c0                	test   %al,%al
80105e3c:	74 12                	je     80105e50 <uartinit+0xf0>
80105e3e:	88 45 e6             	mov    %al,-0x1a(%ebp)
80105e41:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105e45:	88 45 e7             	mov    %al,-0x19(%ebp)
80105e48:	eb ae                	jmp    80105df8 <uartinit+0x98>
...
80105ec6:	68 30 5d 10 80       	push   $0x80105d30
