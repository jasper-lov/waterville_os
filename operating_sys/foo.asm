...
int main(int argc, char *argv[]) {
  ...
  40:	0f 84 82 00 00 00    	je     c8 <main+0xc8>
      // parent
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  46:	e8 88 03 00 00       	call   3d3 <getpid>
  4b:	53                   	push   %ebx
  for ( k = 0; k < n; k++ ) {
  ...
  57:	e8 64 04 00 00       	call   4c0 <printf>
      wait();
  5c:	e8 fa 02 00 00       	call   35b <wait>
  61:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  64:	39 fe                	cmp    %edi,%esi
  66:	7d 2a                	jge    92 <main+0x92>
    pid = fork ();
  68:	e8 de 02 00 00       	call   34b <fork>
  6d:	89 c3                	mov    %eax,%ebx
    if ( pid < 0 ) {
  6f:	85 c0                	test   %eax,%eax
  71:	79 cd                	jns    40 <main+0x40>
      printf(1, "%d failed in fork!\n", getpid());
  73:	e8 5b 03 00 00       	call   3d3 <getpid>
  78:	83 ec 04             	sub    $0x4,%esp
  for ( k = 0; k < n; k++ ) {
  7b:	83 c6 01             	add    $0x1,%esi
      printf(1, "%d failed in fork!\n", getpid());
  7e:	50                   	push   %eax
  ...
  for ( k = 0; k < n; k++ ) {
  8e:	39 fe                	cmp    %edi,%esi
  90:	7c d6                	jl     68 <main+0x68>
  ...
  9a:	ff 70 04             	push   0x4(%eax)
  9d:	e8 3e 02 00 00       	call   2e0 <atoi>
  if (n < 0 ||n > 20)
  a2:	83 c4 10             	add    $0x10,%esp
        n = atoi(argv[1]);
  a5:	89 c7                	mov    %eax,%edi
  if (n < 0 ||n > 20)
  a7:	83 f8 14             	cmp    $0x14,%eax
  aa:	76 34                	jbe    e0 <main+0xe0>
  printf(1, "creating %d processes!\n", n);
  ac:	53                   	push   %ebx
        n = 2;
  ...
  printf(1, "creating %d processes!\n", n);
  b2:	6a 02                	push   $0x2
  b4:	68 e8 07 00 00       	push   $0x7e8
  b9:	6a 01                	push   $0x1
  bb:	e8 00 04 00 00       	call   4c0 <printf>
  c0:	83 c4 10             	add    $0x10,%esp
  c3:	e9 6b ff ff ff       	jmp    33 <main+0x33>
        printf(1,"Child %d created\n",getpid());
  c8:	e8 06 03 00 00       	call   3d3 <getpid>
  cd:	52                   	push   %edx
  ce:	50                   	push   %eax
  cf:	68 31 08 00 00       	push   $0x831
  d4:	6a 01                	push   $0x1
  d6:	e8 e5 03 00 00       	call   4c0 <printf>
  db:	83 c4 10             	add    $0x10,%esp
        for(z = 0; z < 4000000000; z+=1)
  de:	eb fe                	jmp    de <main+0xde>
  printf(1, "creating %d processes!\n", n);
  e0:	51                   	push   %ecx
  e1:	50                   	push   %eax
  e2:	68 e8 07 00 00       	push   $0x7e8
  e7:	6a 01                	push   $0x1
  e9:	e8 d2 03 00 00       	call   4c0 <printf>
  for ( k = 0; k < n; k++ ) {
  ee:	83 c4 10             	add    $0x10,%esp
  f1:	85 ff                	test   %edi,%edi
  f3:	0f 85 3a ff ff ff    	jne    33 <main+0x33>
  f9:	eb 97                	jmp    92 <main+0x92>
  fb:	66 90                	xchg   %ax,%ax
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 4c 08 00 00 	jmp    *0x84c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 43 08 00 00       	mov    $0x843,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 b8 08 00 00       	mov    0x8b8,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 b8 08 00 00    	mov    %edx,0x8b8
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 b8 08 00 00    	mov    %edx,0x8b8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d b8 08 00 00    	mov    0x8b8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d b8 08 00 00    	mov    0x8b8,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 b8 08 00 00    	mov    0x8b8,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 b8 08 00 00    	mov    %edx,0x8b8
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 b8 08 00 00 bc 	movl   $0x8bc,0x8b8
 7b7:	08 00 00 
    base.s.size = 0;
 7ba:	bf bc 08 00 00       	mov    $0x8bc,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 bc 08 00 00 bc 	movl   $0x8bc,0x8bc
 7c6:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
