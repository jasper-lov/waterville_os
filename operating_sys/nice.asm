...
free(void *ap)
{
 ...
 5d1:	a1 00 08 00 00       	mov    0x800,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 00 08 00 00    	mov    %edx,0x800
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 00 08 00 00    	mov    %edx,0x800
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 00 08 00 00    	mov    0x800,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 00 08 00 00    	mov    0x800,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 00 08 00 00    	mov    0x800,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 00 08 00 00    	mov    %edx,0x800
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 00 08 00 00 04 	movl   $0x804,0x800
 727:	08 00 00 
    base.s.size = 0;
 72a:	bf 04 08 00 00       	mov    $0x804,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 04 08 00 00 04 	movl   $0x804,0x804
 736:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 08 08 00 00 00 	movl   $0x0,0x808
 742:	00 00 00 
    if(p->s.size >= nunits){
